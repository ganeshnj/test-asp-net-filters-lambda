...
WORKDIR /src
COPY ["test-asp-net-filters.csproj", "test-asp-net-filters/"]
RUN dotnet restore "test-asp-net-filters/test-asp-net-filters.csproj"

WORKDIR "/src/test-asp-net-filters"
COPY . .
RUN dotnet build "test-asp-net-filters.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "test-asp-net-filters.csproj" \
...
Execute unit tests
```
    cd "test-asp-net-filters/test/test-asp-net-filters.Tests"
    dotnet test
```

Deploy application
```
    cd "test-asp-net-filters/src/test-asp-net-filters"
